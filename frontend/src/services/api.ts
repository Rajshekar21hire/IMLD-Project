...
export const storyAPI = {
  ...
  agenticMeaning: (data: any) => storyApiClient.post('/stories/agentic-meaning', data),
  agenticAction: (data: any) => storyApiClient.post('/stories/agentic-action', data),
  agenticNeighbours: (data: any) => storyApiClient.post('/stories/agentic-neighbours', data),
  agenticBreath: (data: any) => storyApiClient.post('/stories/agentic-breath', data),
